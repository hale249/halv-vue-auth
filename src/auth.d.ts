...
export declare const createAuth: (options: AuthOptions, router: Router, axios: AxiosInstance) => import("pinia").StoreDefinition<"auth", import("pinia")._UnwrapAll<Pick<{
    ...
    loginAs: <U = AuthUser>(user: U, token: string) => Promise<{
        code: number;
        data: {
            user: U;
            token: string;
    ...
    setRefreshTokenData: (data: any) => void;
    getLocalUser: <T = AuthUser>() => T;
}, "setUser" | "setToken" | "logout" | "login" | "loginAs" | "forceLogout" | "fetchUser" | "setTokenHeader" | "refreshToken" | "setRefreshToken" | "getRefreshToken" | "getToken" | "getUser" | "getFreshToken" | "isExpired" | "setTokenExpiration" | "handleRefreshTokenFailed" | "getTokenExpirationTime" | "setRefreshTokenData" | "getLocalUser">>;
